										...
										<ul className="ps-3">
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													<p className="text-300 text-nowrap fw-regular mb-0">2022-2022:</p>
													<div>
														<span className="text-primary-2">Udemy</span>
														<p className="text-dark">Certification in DevOps</p>
													</div>
												</div>
											</li>
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													...
													<div>
														<span className="text-primary-2">Coursera </span>
														<p className="text-dark">Certification in GCP Foundation & </p>
													</div>
												</div>
											</li>
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													...
													<div>
														<span className="text-primary-2">ALX Africa</span>
														<p className="text-dark">Certification in Software Engineering</p>
													</div>
												</div>
											</li>
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													<p className="text-300 text-nowrap fw-regular mb-0">2014-2018:</p>
													<div>
														<span className="text-primary-2">Technical University of Mombasa</span>
														<p className="text-dark">BSc. in Statistics and Computer Science</p>
													</div>
												</div>
											</li>
										</ul>
