						...
						<div className="col-lg-5 d-flex flex-column ps-lg-8">
							<div className="d-flex align-items-center mb-3 position-relative d-inline-flex">
								...
								<div className="ps-3 h-100">
									...
									<h6 className="mb-0">+254-708-520-548</h6>
								</div>
							...
							<div className="d-flex align-items-center mb-3 position-relative d-inline-flex">
								...
								<div className="ps-3 h-100">
									...
									<h6 className="mb-0">titusnjuguna59@gmail.com</h6>
								</div>
							...
							<div className="d-flex align-items-center mb-3 position-relative d-inline-flex">
								...
								<div className="ps-3 h-100">
									...
									<h6 className="mb-0">Titus Njuguna</h6>
								</div>
							...
							<div className="d-flex align-items-center mb-3 position-relative d-inline-flex">
								...
								<div className="ps-3 h-100">
									...
									<h6 className="mb-0">59 00100 Nairobi, Kenya</h6>
								</div>
