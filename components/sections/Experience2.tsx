							...
							<div className="p-lg-8 p-md-6 p-3 position-relative z-1">
								...
								<div className="row mt-5">
										...
										<div className="d-flex flex-column gap-2">
											<Link href="#" className="technology border border-1 rounded-3 p-3">
												<div className="d-flex align-items-center gap-2">
													...
													<div className="d-flex flex-column ms-2">
														<h5 className="mb-1">Naivera Ltd</h5>
											...
											<Link href="#" className="technology border border-1 rounded-3 p-3">
												<div className="d-flex align-items-center gap-2">
													...
													<div className="d-flex flex-column ms-2">
														<h5 className="mb-1">Le'doux Ltd(X)</h5>
											...
											<Link href="#" className="technology border border-1 rounded-3 p-3">
												<div className="d-flex align-items-center gap-2">
													...
													<div className="d-flex flex-column ms-2">
														<h5 className="mb-1">Laikam Ltd</h5>
									...
									<div className="col-lg-8 ps-lg-5 mt-5 mt-lg-0">
										<h6 className="text-linear-4">Senior Software Engineer lead</h6>
										<ul className="mt-4">
